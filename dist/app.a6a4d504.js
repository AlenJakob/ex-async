...
var addToDom = function addToDom(listOfUsers) {
  var mainDiv = document.querySelector(".main");

  var _iterator = _createForOfIteratorHelper(listOfUsers),
      _step;
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var _step$value = _step.value,
          ...
          gender = _step$value.gender,
          status = _step$value.status,
          updated_at = _step$value.updated_at,
          created_at = _step$value.created_at;
      console.log(name);
      mainDiv.innerHTML += "\n    <ul>\n    <h5>".concat(name, "</h5>\n    </ul>\n    ");
    }
  } catch (err) {
